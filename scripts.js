...
{
	let reqUrl = window.location.protocol + "//" + window.location.host + "/livepreview/isLivePreviewDirty?folder=" + cp.previewFolder;
				...
				window.addEventListener("load",function() 
				{
					...
					{					
						...
						script.onload = function()
						{
							...
							let lJSFiles = [  'assets/js/jquery-3.3.1.min.js','assets/js/CPM.js','assets/playbar/playbarScript.js' ];
							cpXHRJSLoader.js(lJSFiles,function()
							{
								//console.log("js loaded");

								let imagesJSONFiles = [ 'dr/imgmd.json' ];
								cpXHRJSLoader.loadImagesJSON(imagesJSONFiles,function(imageToJSONPathMap){
									cp.imageToJSONPathMap = imageToJSONPathMap;
									let imageJSONFiles = [ 'dr/img1.json' ];
